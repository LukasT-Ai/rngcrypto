    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard
            label="Total P&L"
            value={hasTrades ? `${(stats.totalPnl >= 0 ? "+" : "")}${stats.totalPnl.toLocaleString()} USDM` : "--"}
            subtext="Mainnet"
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="flex flex-col items-center gap-8 sm:flex-row sm:justify-center sm:gap-16">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-3 text-white/40 transition-colors hover:text-[#FF3B5C]/80"
          >
            <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
